...
TBD — This capability provides a raw/rendered markdown toggle in the explore panel header, allowing users to switch between plain-text and interpreted markdown display for assistant messages, with persistence via localStorage.
