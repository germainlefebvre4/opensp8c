...
Vue chronologique de tous les changes du workspace. Permet de visualiser l'historique complet des changes (actifs et archivés) regroupés par mois, avec filtrage par tags sémantiques et heatmap des composants fréquents.
